...
sed -e "s/<SNInstanceName>/${SNInstanceName}.service-now.com/g" /home/ec2-user/git/containermid/hlamiddeploy.yaml.template | \
sed -e "s/<miduser>/$miduser/g" | \
sed -e "s/<midpass>/$midpass/g" | \
sed -e "s/<midname>/$midname/g"  > /home/ec2-user/git/containermid/hlamiddeploy.yaml
...
# Deploy the MID
kubectl apply -f /home/ec2-user/git/containermid/hlamiddeploy.yaml
